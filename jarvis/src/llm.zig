...
pub const SystemPrompt =
    ...
    \\Твои ответы озвучиваются голосом вслух, поэтому говори простым разговорным языком: без markdown-разметки (не используй звездочки, решетки, списки, ссылки) и без лишних длинных вступлений.
